            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        spacing: 6
                        SidebarTabButton { Layout.fillWidth: true; text: "Mission"; iconSource: AssetRegistry.icons.lucide_route; active: root.activeTab === "mission"; onClicked: if (accessManager.canPerform("mission_planning")) root.activeTab = "mission" }
                        SidebarTabButton { Layout.fillWidth: true; text: "Material"; iconSource: AssetRegistry.icons.cube; active: root.activeTab === "material"; onClicked: if (accessManager.canPerform("aircraft_profile_access")) root.activeTab = "material" }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            opacity: accessManager.canPerform("mission_planning") ? 1 : 0.48
                        ...
                        Rectangle {
                            ...
                            Layout.preferredHeight: 44
                            radius: 8
                            opacity: accessManager.canPerform("settings") ? 1 : 0.48
                            color: settingsMouse.containsMouse && accessManager.canPerform("settings") ? "#f2ecfb" : "#ffffff"
                            border.color: root.line
                            AssetIcon { anchors.centerIn: parent; width: 18; height: 18; iconSize: 18; source: AssetRegistry.icons.edit; active: true }
                            MouseArea { id: settingsMouse; anchors.fill: parent; hoverEnabled: true; onClicked: if (accessManager.canPerform("settings")) root.showPanel("Dashboard Settings", "Mission sidebar preferences, filters, and cached mission controls are ready.") }
                        }
                    }
                }
            }
                                    ...
                                    ColumnLayout {
                                        ...
                                        RowLayout {
                                            ...
                                            Rectangle {
                                                ...
                                                opacity: accessManager.canPerform("aircraft_profile_access") ? 1 : 0.48
                                                MouseArea { id: fleetMouse; anchors.fill: parent; hoverEnabled: true; onClicked: if (accessManager.canPerform("aircraft_profile_access")) root.showPanel("Fleet Center", "Aircraft telemetry, health, assignment, maintenance, and live status are ready for expansion.") }
                                            }
                                        }
                                ...
                                Rectangle {
                                    ...
                                    ColumnLayout {
                                        ...
                                        GridLayout {
                                            ...
                                            rowSpacing: 14
                                            columnSpacing: 14
                                            QuickActionTile { Layout.fillWidth: true; Layout.fillHeight: true; iconSource: AssetRegistry.icons.plane; title: "Pilot Mode"; subtitle: "Live control"; primary: true; enabled: accessManager.canPerform("manual_flight"); onClicked: root.startPilotMode() }
                                            QuickActionTile { Layout.fillWidth: true; Layout.fillHeight: true; iconSource: AssetRegistry.icons.plus; title: "New Mission"; subtitle: "Plan route"; enabled: accessManager.canPerform("mission_planning"); onClicked: root.openNewMission() }
                                            ...
                                            QuickActionTile { Layout.fillWidth: true; Layout.fillHeight: true; iconSource: AssetRegistry.icons.boxicons_save; title: "Logs"; subtitle: "Flight events"; enabled: accessManager.canPerform("security_audit"); onClicked: root.showPanel("Flight Logs", "Recent GCS events, telemetry sync events, and mission logs are available in the activity stream.") }
                                        }
                                    }
                                }
                            }
