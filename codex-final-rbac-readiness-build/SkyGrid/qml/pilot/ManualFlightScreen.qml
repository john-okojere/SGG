        ...
        Item {
            ...
            Row {
                ...
                Button {
                    ...
                    height: 34
                    text: "Go To"
                    enabled: accessManager.canPerform("manual_flight")
            ...
            VirtualJoystickOverlay {
                ...
                enabled: telemetryStore.inAir && vehicleManager.connected && sessionManager.operationsAllowed && accessManager.canPerform("manual_flight")
            }
        }
