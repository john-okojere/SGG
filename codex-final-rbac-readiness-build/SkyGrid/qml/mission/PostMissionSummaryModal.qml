            ...
            Flickable {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        spacing: 10
                        ActionButton { text: "View Full Log"; enabled: accessManager.canPerform("security_audit"); onClicked: postMissionSummaryManager.viewFullLog() }
                        ActionButton { text: "Export Report"; enabled: accessManager.canPerform("telemetry_export"); onClicked: postMissionSummaryManager.exportReport() }
                        ActionButton { text: "Sync Now"; enabled: accessManager.canPerform("telemetry_export"); onClicked: postMissionSummaryManager.syncNow() }
                        Item { Layout.fillWidth: true }
                        ActionButton { text: "Return to Dashboard"; filled: true; onClicked: postMissionSummaryManager.returnToDashboard() }
                        ActionButton { text: "Start New Mission"; filled: true; enabled: accessManager.canPerform("mission_planning"); onClicked: postMissionSummaryManager.startNewMission() }
                    }
                }
            }
        }
