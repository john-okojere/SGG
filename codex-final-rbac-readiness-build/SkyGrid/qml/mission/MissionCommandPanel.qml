    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            CommandButton {
                ...
                enabled: sessionManager.operationsAllowed && accessManager.canPerform("manual_flight") && vehicleManager.connected && preflightChecklistManager.canArm && !vehicleActionManager.busy && !telemetryStore.armed
            ...
            CommandButton {
                ...
                enabled: sessionManager.operationsAllowed && accessManager.canPerform("manual_flight") && vehicleManager.connected && preflightChecklistManager.canArm && !vehicleActionManager.busy
            ...
            CommandButton {
                ...
                enabled: sessionManager.operationsAllowed && accessManager.canPerform("manual_flight") && vehicleManager.connected && !vehicleActionManager.busy && telemetryStore.armed
            ...
            CommandButton {
                ...
                iconSource: AssetRegistry.icons.iconamoon_arrow_up_2
                iconRotation: 180
                enabled: sessionManager.operationsAllowed && accessManager.canPerform("manual_flight") && vehicleManager.connected && !vehicleActionManager.busy
