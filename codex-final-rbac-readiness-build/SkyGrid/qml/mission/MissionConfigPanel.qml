...
Rectangle {
    ...
    function canStartFlying() {
        if (root.isVirtualFence)
            return accessManager.canPerform("mission_validation")
        return accessManager.canPerform("mission_save")
            && accessManager.canPerform("mission_validation")
            && accessManager.canPerform("aircraft_connection")
            && accessManager.canPerform("mission_upload")
            && accessManager.canPerform("mission_start")
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ActionButton {
                ...
                iconText: "✓"
                primary: false
                enabled: sessionManager.operationsAllowed && accessManager.canPerform("mission_validation")
