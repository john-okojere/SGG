...
ColumnLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PrimaryButton {
                    ...
                    enabled: vehicleManager.connected && accessManager.canPerform("manual_flight")
                    onClicked: {
                        manualControlManager.neutral()
                        vehicleActionManager.holdPosition()
                    }
                ...
                PrimaryButton {
                    ...
                    enabled: vehicleManager.connected && accessManager.canPerform("emergency_stop")
    ...
    component PadButton: Button {
        ...
        enabled: vehicleManager.connected && sessionManager.operationsAllowed && accessManager.canPerform("manual_flight")
        hoverEnabled: true
