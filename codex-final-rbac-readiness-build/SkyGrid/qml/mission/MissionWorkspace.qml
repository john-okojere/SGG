...
Item {
    ...
    Rectangle {
        ...
        border.width: 1
        z: 9
        visible: accessManager.canPerform("mission_planning")
        Row {
            anchors.centerIn: parent
            spacing: 8
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            MissionToolButton { Layout.fillWidth: true; iconSource: AssetRegistry.icons.plane; tool: "takeoff"; label: "Takeoff"; enabled: accessManager.canPerform("mission_planning") }
            MissionToolButton { Layout.fillWidth: true; iconSource: AssetRegistry.icons.pin_location; tool: "point"; enabled: accessManager.canPerform("mission_planning") }
            MissionToolButton { Layout.fillWidth: true; iconSource: AssetRegistry.icons.lucide_waypoints; tool: "poi"; enabled: accessManager.canPerform("mission_planning") }
            MissionToolButton { Layout.fillWidth: true; iconSource: AssetRegistry.icons.lucide_route; tool: "route"; enabled: accessManager.canPerform("mission_planning") }
            MissionToolButton { Layout.fillWidth: true; iconSource: AssetRegistry.icons.lucide_grid_3x3; tool: "polygon"; enabled: accessManager.canPerform("mission_planning") }
            IconButton {
                Layout.fillWidth: true
                iconSource: AssetRegistry.icons.boxicons_undo
                enabled: accessManager.canPerform("mission_planning")
