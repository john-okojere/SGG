...
Rectangle {
    ...
    property string pilotName: "Signed-out operator"
    property string organization: "No organization"
    property string unitSystem: "METRIC"
    property string assignment: "Unassigned"
    property string clearance: "No role"
    property string lastLogin: "No active session"
    property bool canPilotMode: false
    property bool canChangePilot: false
    ...
    component ActionButton: Rectangle {
        ...
        Text {
            anchors.centerIn: parent
            text: action.text
            color: action.primary ? "#ffffff" : "#3b0787"
            font.pixelSize: 11
            font.bold: true
        }
        MouseArea {
